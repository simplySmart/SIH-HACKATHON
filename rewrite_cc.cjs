...
import { 
  ...
  Leaf, ChevronRight, Activity, Satellite, Cpu, Truck, Clock
} from 'lucide-react';
...
export default function CommandCenter() {
  ...
  return (
    <div className="flex flex-col h-full bg-transparent overflow-y-auto space-y-6 pb-12">
      ...
      {/* Hero Banner */}
      <div className="relative w-full h-64 rounded-3xl overflow-hidden shadow-lg border border-gray-200">
        <img 
          src="https://images.unsplash.com/photo-1628102491629-778571d893a3?auto=format&fit=crop&q=80&w=2000" 
          alt="Forest Fire" 
      ...
      {/* Bottom Banner */}
      <div className="w-full bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100 rounded-2xl p-5 flex items-center justify-between shadow-sm overflow-hidden relative">
      ...
      <div className="flex gap-6">
        ...
        <div className="w-[400px] bg-white p-5 rounded-2xl border border-gray-200 shadow-sm shrink-0 flex flex-col justify-center">
...
fs.writeFileSync('src/components/CommandCenter.tsx', code);
