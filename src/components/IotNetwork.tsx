              ...
              <div className="flex-1 overflow-y-auto">
                <div className="p-5 space-y-6">
                  ...
                  {selectedSensor.history.length > 0 && (
                    <div>
                      <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-3">Trends (Last Hour)</h3>
                  ...
                  {selectedSensor.gatewayId && (
                    <div>
                      <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-3">Gateway Node</h3>
                      {getGatewayForSensor(selectedSensor.gatewayId) && (
                        <div className="p-3 bg-blue-50 border border-blue-100 rounded-xl flex items-center justify-between">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-[10px] text-gray-500 font-bold uppercase mt-0.5">{getGatewayForSensor(selectedSensor.gatewayId)!.lastHeartbeat}</div>
                          </div>
                        </div>
                      )}
                    </div>
