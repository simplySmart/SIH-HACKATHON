    ...
    <div className="flex flex-col h-full bg-transparent overflow-hidden rounded-3xl">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-5 gap-4">
          <div className="bg-red-500/10 p-4 rounded-xl border border-red-500/20 flex flex-col justify-between">
          ...
          <div className="bg-yellow-500/10 p-4 rounded-xl border border-yellow-500/20 flex flex-col justify-between">
        ...
        <div className="flex gap-6 h-[600px]">
          {/* Map Column */}
          <div className="flex-1 bg-[#0f1912]/80 backdrop-blur-3xl rounded-2xl border border-white/10 shadow-sm overflow-hidden flex flex-col relative z-0">
          ...
          <div className="w-[450px] flex flex-col gap-6 shrink-0">
            {/* District Rankings */}
            <div className="bg-[#0f1912]/80 backdrop-blur-3xl rounded-2xl border border-white/10 shadow-sm p-5 flex flex-col h-1/2">
